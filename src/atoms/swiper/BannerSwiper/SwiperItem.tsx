...
const SwiperItem = ({ item }: Props) => (
  <div
    className={`relative overflow-hidden bg-cover rounded-2xl bg-center	 bg-no-repeat text-center w-full flex-shrink-0 bg-[url('${item.imageSrc}')] object-cover w-full h-full`}
  >
